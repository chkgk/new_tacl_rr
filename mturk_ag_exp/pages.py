...
class Introduction(Page):
    template_name = 'mturk_ag_exp/Introduction.html'
...
class PersonalInformation(Page):
    template_name = 'mturk_ag_exp/PersonalInformation.html'
    form_model = 'player'
...
class ReceiverWaitPage(Page):
    template_name = 'mturk_ag_exp/ReceiverWaitPage.html'

    timeout_seconds = 1


class ReceiverPage(Page):
    template_name = 'mturk_ag_exp/ReceiverPage.html'
...
class Results(Page):
    ...
    template_name = 'mturk_ag_exp/Results.html'
...
class GameOver(Page):
    ...
    """
    template_name = 'mturk_ag_exp/GameOver.html'
