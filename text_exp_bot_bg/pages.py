...
class IntroTestFeedback(Page):
    ...
    def vars_for_template(self):
        ...
        # sender = self.group.get_player_by_role('Expert')
        receiver = self.group.get_player_by_role('Decision Maker')
        #  = sender.participant.vars.get('failed_intro_test')
...
class Test(Page):
    ...
    """
    template_name = 'text_exp_bot_bg/Test.html'
    form_model = 'player'
...
class FeedbackTest(Page):
    ...
    """
    template_name = 'text_exp_bot_bg/FeedbackTest.html'
...
#     """
#     template_name = 'text_exp_bot_bg/GameOver.html'
#
...
class OnePlayerWait(Page):
    ...
    """
    template_name = 'text_exp_bot_bg/OnePlayerWait.html'
...
class AfterAutoSubmit(Page):
    ...
    """
    template_name = 'text_exp_bot_bg/afterAutoSubmit.html'
