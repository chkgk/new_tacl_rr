                ...
                for p in g.get_players():
                    if p.id_in_group == 1:  # create the parameters only for experts:
                        ...
                        df = pd.DataFrame(columns=[
                            'pair_id', 'review_id', 'subsession_round_number',
                            'lottery_result_low', 'lottery_result_med1', 'lottery_result_high',
                            'group_lottery_result', 'group_receiver_payoff', 'group_sender_answer_index',
                            'group_sender_payoff', 'group_sender_answer_reviews', 'group_average_score'
                                                                                  'chose_lose', 'chose_earn',
                            'not_chose_lose', 'not_chose_earn',
                            'group_sender_answer_scores', 'group_score_0', 'group_score_1', 'group_score_2',
                            'group_score_3', 'group_score_4', 'group_score_5', 'group_score_6',
                            ...
                            'group_random_positive_negative_review_5', 'group_random_positive_negative_review_6',
                            'group_positive_review_5', 'group_positive_review_6', 'group_positive_review_4',
                            'group_positive_review_3', 'group_positive_review_2', 'group_positive_review_1',
...
class Player(BasePlayer):
    ...
    df = pd.DataFrame(columns = [
        'pair_id','review_id','subsession_round_number',
        'lottery_result_low', 'lottery_result_med1','lottery_result_high',
        'group_lottery_result','group_receiver_payoff','group_sender_answer_index','group_sender_payoff','group_sender_answer_reviews','group_average_score'
                       'chose_lose', 'chose_earn', 'not_chose_lose', 'not_chose_earn',
                        'group_sender_answer_scores','group_score_0','group_score_1','group_score_2','group_score_3','group_score_4','group_score_5','group_score_6',
    'group_random_positive_negative_review_0','group_random_positive_negative_review_1','group_random_positive_negative_review_2','group_random_positive_negative_review_3','group_random_positive_negative_review_4',
    'group_random_positive_negative_review_5','group_random_positive_negative_review_6',
    'group_positive_review_5','group_positive_review_6','group_positive_review_4','group_positive_review_3','group_positive_review_2','group_positive_review_1','group_positive_review_0',
